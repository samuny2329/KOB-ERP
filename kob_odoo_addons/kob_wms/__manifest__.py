{
    ...
    'description': """
KOB WMS Pro — WH-Online E-Commerce
==================================
Imported from the Odoo 18 build at v18.0.2.29.0 and re-targeted at Odoo 19
as part of the KOB ERP distribution.  Sits under the **WH-Online E-Commerce**
section of the KOB ERP menu.  Functional scope unchanged.
...
* Security groups (Worker / Supervisor / Manager)
    ...
    'data': [
        ...
        'wizards/import_pick_group_wizard_views.xml',
        'wizards/stock_valuation_at_date_wizard_views.xml',
        ...
        'report/kob_wms_user_qr_template.xml',
        'report/wms_qr_url_template.xml',
        'wizards/wms_eod_manifest_wizard_views.xml',
        'wizards/wms_qr_url_wizard_views.xml',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            # ── Daily Pick Demand list (row-click → action_view_orders) ──────
            'kob_wms/static/src/js/wms_pick_demand_list/wms_pick_demand_list.js',
            ...
            'kob_wms/static/src/js/wms_mobile/screens/pack_screen.js',
            'kob_wms/static/src/js/wms_mobile/screens/pack_screen.xml',
            'kob_wms/static/src/js/wms_mobile/screens/out_screen.js',
