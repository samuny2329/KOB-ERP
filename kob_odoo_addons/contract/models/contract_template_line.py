...
class ContractTemplateLine(models.Model):
    ...
    # Odoo 19: uom.uom.category_id and uom.category model removed.
    # product_uom_category_id field dropped; uom_id has no category constraint.
    ...
    def _compute_uom_id(self):
        # Odoo 19: uom.category removed — fall through to product's UoM if missing
        for line in self:
